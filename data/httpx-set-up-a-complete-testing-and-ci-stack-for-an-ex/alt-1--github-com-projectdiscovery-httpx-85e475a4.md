...
role: "alternate"
rank: 1
fetched_at: "2026-08-17T19:28:29.095752+00:00"
fetched_via: "brightdata-collector:c_msx9i6aq2bz5dznadk"
sha256: "58dee35e730744db291213058c432cf121f367dd960d40cb2c2b3657e2b86481"
---

# [httpx](/projectdiscovery/httpx/blob/dev/static/httpx-logo.png)

[!](https://opensource.org/licenses/MIT)   [!](https://goreportcard.com/badge/github.com/projectdiscovery/httpx)   [!](https://github.com/projectdiscovery/httpx/releases)   [!](https://hub.docker.com/r/projectdiscovery/httpx)   [!](https://twitter.com/pdiscoveryio)   [!](https://discord.gg/projectdiscovery)

[Features](#features) • [Installation](#installation-instructions) • [Usage](#usage) • [Documentation](https://docs.projectdiscovery.io/tools/httpx/) • [Notes](#notes) • [Join Discord](https://discord.gg/projectdiscovery)
...
# [httpx](https://user-images.githubusercontent.com/8293321/135731750-4c1d38b1-bd2a-40f9-88e9-3c4b9f6da378.png)
...
`httpx` can be used as a library by creating an instance of the `Option` struct and populating it with the same options that would be specified via CLI. Once validated, the struct should be passed to a runner instance (to be closed at the end of the program) and the `RunEnumeration` method should be called. A minimal example of how to do it is in the [examples](/projectdiscovery/httpx/blob/dev/examples) folder.
...
'contains(content_type, "text/plain") && contains(body, "Contact:") && contains_any(body, "mailto:", "https://")'
```
...
|
'/sitemap.xml'
'contains_any(content_type, "application/xml", "text/xml") && contains(body, "<urlset")'
```
...
|
'/ads.txt'
'contains(content_type, "text/plain") && contains(body, "google.com")'
```
...
'contains(content_type, "application/json") && contains(body, "\"issuer\"")'
```
...
echo
|
'/.well-known/apple-app-site-association,/.well-known/apple-app-site-association.json'
'contains(content_type, "application/json") && contains(body, "\"applinks\"")'
```
...
'contains(content_type, "application/json") && contains(body, "\"android_app\"")'
```
...
|
'/crossdomain.xml'
'contains_any(content_type, "application/xml", "text/xml") && contains(body, "cross-domain-policy")'
```
...
`httpx` is made with 💙 by the [projectdiscovery](https://projectdiscovery.io) team and distributed under [MIT License](/projectdiscovery/httpx/blob/dev/LICENSE.md) .
