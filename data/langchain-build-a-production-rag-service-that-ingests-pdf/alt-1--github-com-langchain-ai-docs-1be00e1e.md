...
role: "alternate"
rank: 1
fetched_at: "2026-08-18T08:56:28.571657+00:00"
fetched_via: "brightdata-collector:c_msx9i6aq2bz5dznadk"
sha256: "60459c831a274e9c3131ba7f894a5e4224d849ba3149b1d66fe896ba25f41635"
---
...
1. **Use the safe Make commands** (recommended):
   ...
   ```
   # Builds docs first, then checks internal links
   ```
2. **Run Mintlify commands from the build directory** :

   ```
   cd
   # Change to build directory where final docs are
   # Now safe to run
   ```
