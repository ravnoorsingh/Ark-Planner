...
role: "primary"
rank: 0
fetched_at: "2026-08-20T15:09:56.464840+00:00"
fetched_via: "brightdata-collector:c_msx9i6aq2bz5dznadk"
sha256: "592992823df3a28e6e90eb98ffc845595d86696215c6591cbb1d44fa79c69093"
---

[![NumPy](_static/numpylogo.svg)](https://numpy.org)

# NumPy Documentation

* [Web](https://numpy.org/doc/stable/)
* [Latest (development) documentation](https://numpy.org/devdocs/)
* [NumPy Enhancement Proposals](/neps)

Versions:

Remember to run python3 update.py after editing this!  * [NumPy 2.5 Manual](2.5)
    [[HTML+zip]](2.5/numpy-html.zip)   [[Reference Guide PDF]](2.5/numpy-ref.pdf)   [[User Guide PDF]](2.5/numpy-user.pdf)
...
* [NumPy 1.26 Manual](1.26)
    [[HTML+zip]](1.26/numpy-html.zip)
* [NumPy 1.25 Manual](1.25)
    [[HTML+zip]](1.25/numpy-html.zip)
* [NumPy 1.24 Manual](1.24)
    [[HTML+zip]](1.24/numpy-html.zip)
...
* [Older versions (on scipy.org)](https://docs.scipy.org/doc/)

* © Copyright 2008-2025 NumPy. All rights reserved.
